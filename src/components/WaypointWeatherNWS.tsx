...
export type IWaypointWeatherNWSProps = {
    name: string;
    lat: number;
    long: number;
};
...
const WaypointWeatherNWS: React.FunctionComponent<IWaypointWeatherNWSProps> = ({
    name,
    lat,
    long,
}) => {
...
WaypointWeatherNWS.displayName = 'WaypointWeatherNWS';

export default WaypointWeatherNWS;
